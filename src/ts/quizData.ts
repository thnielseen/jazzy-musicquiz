...
export const quizQuestions: QuizQuestion[] = [
  ...
  new QuizQuestion(
    ...
    ['spend his money', 'drink my money', 'drink his money', 'spend my money'],
    'drink my money',
  ),
  new QuizQuestion(
  ...
  new QuizQuestion(
    ...
    ['all I need', 'in the sun', 'what I see', 'what I need'],
    'all I need',
  ),
  new QuizQuestion(
    "When the night has come <br> And the land is dark <br> [ _______ ] is the only light we'll see",
    ['And the stars', 'And the fire', 'And your charm', 'And the moon'],
    'And the moon',
  ),
  new QuizQuestion(
  ...
  new QuizQuestion(
    ...
    ['my heart swells', 'I touch myself', 'I lose myself', 'I start to melt'],
    'I touch myself',
  ),
  new QuizQuestion(
    "And when I touch you, I feel happy inside <br> It's such a feelin' that my love <br> [ _______ ]",
    ['I get high', "I can't hide", 'I can fly', 'I could cry'],
    "I can't hide",
  ),
  new QuizQuestion(
  ...
  new QuizQuestion(
    ...
    ['so troublesome', 'a shadow to some', 'so burdensome', 'making me numb'],
    'so burdensome',
  ),
  new QuizQuestion(
